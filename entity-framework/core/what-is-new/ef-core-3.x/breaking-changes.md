...
Die folgenden API-Änderungen und Behavior Changes können dazu führen, dass vorhandene Anwendungen nach einem Upgrade auf 3.x nicht mehr funktionieren.
...
| [Entity Framework Core ist nicht mehr Teil des gemeinsam verwendeten ASP.NET Core-Frameworks](#no-longer) | Medium      |
| [Kaskadierende Deletes werden standardmäßig sofort ausgeführt](#cascade) | Medium      |
...
| [Benutzereigene Entitäten können nicht abgefragt werden, ohne dass der Besitzer eine Nachverfolgungsabfrage verwendet](#owned-query) | Niedrig      |
...
| [Die Datenbankverbindung wird jetzt geschlossen, wenn sie nicht mehr verwendet wird, bevor TransactionScope abgeschlossen wurde](#dbc) | Niedrig      |
...
| [„Nur-Feld“-Eigenschaftsnamen sollten dem Feldnamen entsprechen](#field-only-property-names-should-match-the-field-name) | Niedrig      |
| [Von AddDbContext/AddDbContextPool werden AddLogging und AddMemoryCache nicht mehr aufgerufen.](#adddbc) | Niedrig      |
| [AddEntityFramework* fügt IMemoryCache mit einer Größenbeschränkung hinzu](#addentityframework-adds-imemorycache-with-a-size-limit) | Niedrig      |
...
| [Erweiterungsinformationen und Metadaten aus IDbContextOptionsExtension entfernt](#xinfo) | Niedrig      |
| [LogQueryPossibleExceptionWithAggregateOperator wurde umbenannt](#lqpe) | Niedrig      |
| [Verdeutlichen der API für Einschränkungsnamen von Fremdschlüsseln](#clarify) | Niedrig      |
...
| [SQLitePCL.raw zu Version 2.0.0 aktualisiert](#SQLitePCL) | Niedrig      |
| [NetTopologySuite auf Version 2.0.0 aktualisiert](#NetTopologySuite) | Niedrig      |
| [Microsoft.Data.SqlClient wird statt System.Data.SqlClient verwendet](#SqlClient) | Niedrig      |
...
| [~~EF Core 3.0 zielt auf .NET Standard 2.1 und nicht auf .NET Standard 2.0 ab~~ Zurückgesetzt](#netstandard21) | |
| [~~Die Abfrageausführung wird auf Debugebene protokolliert~~ – zurückgesetzt](#qe) | |

## <a name="high-impact-changes"></a>Änderungen mit hoher Auswirkung

### <a name="linq-queries-are-no-longer-evaluated-on-the-client"></a>LINQ-Abfragen werden nicht mehr auf dem Client ausgewertet

[Issue #14935](https://github.com/dotnet/efcore/issues/14935)
[Siehe auch Issue #12795](https://github.com/dotnet/efcore/issues/12795)
...
Vor dieser Änderung konnte EF Core auf unterschiedliche Arten bezogen werden. Diese richteten sich danach, ob ASP.NET Core und SQL Server oder ein anderes Zielframework für die Anwendung vorgesehen war.
Bei einem Upgrade von ASP.NET Core wurde zudem ein Upgrade von EF Core und des SQL Server-Anbieters erzwungen, was nicht in allen Fällen gewünscht war.
...
[Issue #14016](https://github.com/dotnet/efcore/issues/14016)
...
[Issue #15392](https://github.com/dotnet/efcore/issues/15392)
...
[Issue #15704](https://github.com/dotnet/efcore/issues/15704)
...
[Issue #13518](https://github.com/dotnet/efcore/issues/13518)
...
[Issue #12378](https://github.com/dotnet/efcore/issues/12378)
...
[Issue #14616](https://github.com/dotnet/efcore/issues/14616)
...
[Issue #10114](https://github.com/dotnet/efcore/issues/10114)
...
Diese Änderung wurde vorgenommen, um die Arbeit mit Datenbindungen und Überwachungsszenarios zu vereinfachen, in denen bekannt sein muss, welche Entitäten _vor dem Aufruf von_  `SaveChanges` gelöscht werden.
...
[Issue #18022](https://github.com/dotnet/efcore/issues/18022)
...
[Issue #12661](https://github.com/dotnet/efcore/issues/12661)
...
[Issue #14194](https://github.com/dotnet/efcore/issues/14194)
...
[Issue #12444](https://github.com/dotnet/efcore/issues/12444)
[Issue #9148](https://github.com/dotnet/efcore/issues/9148)
[Issue #14153](https://github.com/dotnet/efcore/issues/14153)
...
[Issue #9005](https://github.com/dotnet/efcore/issues/9005)
...
[Issue #14154](https://github.com/dotnet/efcore/issues/14154)
...
### <a name="owned-entities-cannot-be-queried-without-the-owner-using-a-tracking-query"></a>Benutzereigene Entitäten können nicht abgefragt werden, ohne dass der Besitzer eine Nachverfolgungsabfrage verwendet

[Issue 18876](https://github.com/dotnet/efcore/issues/18876)
...
Fügen Sie andernfalls einen `AsNoTracking()`-Aufruf hinzu:
...
[Issue #13998](https://github.com/dotnet/efcore/issues/13998)
...
[Issue #13274](https://github.com/dotnet/efcore/issues/13274)
...
[Issue #14218](https://github.com/dotnet/efcore/issues/14218)
...
[Issue #6872](https://github.com/dotnet/efcore/issues/6872)
...
[Issue #12430](https://github.com/dotnet/efcore/issues/12430)
...
[Issue #12523](https://github.com/dotnet/efcore/issues/12523)
...
In einer kommenden Version von EF Core nach 3.0 soll das explizite Konfigurieren eines Feldnamens, der sich vom Eigenschaftsnamen unterscheidet, erneut aktiviert werden (siehe Problem [#15307](https://github.com/dotnet/efcore/issues/15307)):
...
Wenn Ihre Anwendung diese Dienste benötigt, registrieren Sie sie explizit mit [AddLogging](/dotnet/api/microsoft.extensions.dependencyinjection.loggingservicecollectionextensions.addlogging) oder [AddMemoryCache](/dotnet/api/microsoft.extensions.dependencyinjection.memorycacheservicecollectionextensions.addmemorycache) beim DI-Container.

### <a name="addentityframework-adds-imemorycache-with-a-size-limit"></a>AddEntityFramework* fügt IMemoryCache mit einer Größenbeschränkung hinzu

[Issue 12905](https://github.com/dotnet/efcore/issues/12905)

#### <a name="old-behavior"></a>Altes Verhalten

Vor EF Core 3.0 wurden bei Aufrufen von `AddEntityFramework*`-Methoden auch Arbeitsspeichercachingdienste ohne eine Größenbeschränkung bei DI registriert.

#### <a name="new-behavior"></a>Neues Verhalten

Ab EF Core 3.0 registriert `AddEntityFramework*` einen IMemoryCache-Dienst mit einer Größenbeschränkung. Wenn danach weitere Dienste hinzugefügt werden, die von IMemoryCache abhängig sind, können diese schnell den Standardgrenzwert erreichen, was zu Ausnahmen und Leistungsbeeinträchtigungen führt.
...
Wenn Ihre Anwendung diese Dienste erfordert, registrieren Sie im Voraus eine IMemoryCache-Implementierung explizit mit dem DI-Container mithilfe von [AddMemoryCache](/dotnet/api/microsoft.extensions.dependencyinjection.memorycacheservicecollectionextensions.addmemorycache).
...
[Issue #13552](https://github.com/dotnet/efcore/issues/13552)
...
[Issue #14617](https://github.com/dotnet/efcore/issues/14617)
...
[Issue #14698](https://github.com/dotnet/efcore/issues/14698)
...
Erstellen Sie in diesen Situationen bitte im [GitHub-Issuetracker für EF Core](https://github.com/dotnet/efcore/issues) ein Issue, in dem Sie beschreiben, wie Sie `ILoggerFactory` verwenden. So können wir in Zukunft erneute Breaking Changes vermeiden.
...
[Issue #12780](https://github.com/dotnet/efcore/issues/12780)
...
[Issue #10236](https://github.com/dotnet/efcore/issues/10236)
...
[Issue #9171](https://github.com/dotnet/efcore/issues/9171)
...
[Issue #15184](https://github.com/dotnet/efcore/issues/15184)
...
[Issue #9913](https://github.com/dotnet/efcore/issues/9913)
...
[Issue #11811](https://github.com/dotnet/efcore/issues/11811)
...
[Issue #12366](https://github.com/dotnet/efcore/issues/12366)
...
[Issue #214](https://github.com/dotnet/efcore/issues/214)
...
[Issue #12151](https://github.com/dotnet/efcore/issues/12151)
...
[Issue #15078](https://github.com/dotnet/efcore/issues/15078)
...
[Issue #15020](https://github.com/dotnet/efcore/issues/15020)
...
[Issue #12978](https://github.com/dotnet/efcore/issues/12978)
...
[Issue #16400](https://github.com/dotnet/efcore/issues/16400)
...
[Issue #16119](https://github.com/dotnet/efcore/issues/16119)
...
[Issue #10985](https://github.com/dotnet/efcore/issues/10985)
...
[Issue #10730](https://github.com/dotnet/efcore/issues/10730)
...
[Issue #15997](https://github.com/dotnet/efcore/issues/15997)
...
[Issue #11506](https://github.com/dotnet/efcore/issues/11506)
...
[Issue #14824](https://github.com/dotnet/efcore/issues/14824)
...
[Issue #14825](https://github.com/dotnet/efcore/issues/14825)
...
### <a name="microsoftdatasqlclient-is-used-instead-of-systemdatasqlclient"></a>Microsoft.Data.SqlClient wird statt System.Data.SqlClient verwendet

[Issue #15636](https://github.com/dotnet/efcore/issues/15636)
...
[Issue #13573](https://github.com/dotnet/efcore/issues/13573)
...
[Issue #12757](https://github.com/dotnet/efcore/issues/12757)
...
### <a name="ef-core-30-targets-net-standard-21-rather-than-net-standard-20-reverted"></a>~~EF Core 3.0 zielt auf .NET Standard 2.1 und nicht auf .NET Standard 2.0 ab~~ Zurückgesetzt
...
[Issue #14523](https://github.com/dotnet/efcore/issues/14523)
